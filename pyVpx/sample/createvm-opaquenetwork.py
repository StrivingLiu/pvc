...
def GetOptions():
   ...
   parser.add_option("-v", "--vm_name", "--vmname",
                     default="CreateTest",
                     help="Name of the virtual machine")
   parser.add_option("-o", "--opaquenetwork_id",
                     default="ovs-testing",
                     help="Id of opaque network")
   parser.add_option("-t", "--opaquenetwork_type",
                     default="nvp.network",
                     help="type of opaque network")
   parser.add_option("-e", "--externalID",
                     default="",
                     help="externalID set on the vNIC")
   parser.add_option("-n", "--vnic_type",
                     default="vmxnet3",
                     help="type of vNIC device (e1000/vmxnet3, etc)")
   parser.add_option("--datastore-name",
                     help="Name of the datastore")
   parser.add_option("-i", "--num-iterations", "--numiter",
                     default=1,
                     help="Number of iterations")
   parser.add_option("--num-scsi-disks",
                     default=1,
                     help="Number of SCSI disks")
   parser.add_option("--num-ide-disks",
                     default=0,
                     help="Number of IDE disks")
   parser.add_option("-c", "--num-power-cycles", "--powercycles",
                     default=0,
                     help="Number of power cycles to perform before delete")
   parser.add_option("-d", "--dont-delete", "--no-delete", "--dontDelete",
                     default=False,
