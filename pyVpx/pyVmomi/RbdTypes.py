...
AddVersion("rbd.version.unstable", "rbd1", "u717CF", 0, "rbd1")
...
AddVersion("rbd.version.stable", "rbd1", "sB75F9", 0, "rbd1")
...
AddVersionParent("rbd.version.disabled", "rbd.version.stable")
...
AddVersionParent("rbd.version.unstable", "rbd.version.stable")
...
AddVersionParent("rbd.version.stable", "vmodl.query.version.version4")
AddVersionParent("rbd.version.stable", "vmodl.query.version.version3")
AddVersionParent("rbd.version.stable", "vmodl.query.version.version2")
AddVersionParent("rbd.version.stable", "vmodl.query.version.version1")
AddVersionParent("rbd.version.stable", "vim.version.version6")
AddVersionParent("rbd.version.stable", "vim.version.version7")
AddVersionParent("rbd.version.stable", "vim.version.version1")
AddVersionParent("rbd.version.stable", "vim.version.version4")
AddVersionParent("rbd.version.stable", "vim.version.version5")
AddVersionParent("rbd.version.stable", "vim.version.version2")
AddVersionParent("rbd.version.stable", "vim.version.version3")
AddVersionParent("rbd.version.stable", "vmodl.version.version0")
AddVersionParent("rbd.version.stable", "vmodl.version.version1")
AddVersionParent("rbd.version.stable", "vmodl.version.version2")
AddVersionParent("rbd.version.stable", "vmodl.reflect.version.version1")
AddVersionParent("rbd.version.stable", "rbd.version.version1")
AddVersionParent("rbd.version.stable", "rbd.version.version3")
AddVersionParent("rbd.version.stable", "rbd.version.version2")
AddVersionParent("rbd.version.stable", "rbd.version.version5")
AddVersionParent("rbd.version.stable", "rbd.version.version4")
AddVersionParent("rbd.version.stable", "rbd.version.stable")

newestVersions.Add("rbd.version.unstable")
stableVersions.Add("rbd.version.stable")
...
CreateManagedType("rbd.CustomCertificateStore", "RbdCustomCertificateStore", "vmodl.ManagedObject", "rbd.version.unstable", None, [("addCertificate", "AddCertificate", "rbd.version.unstable", (("hostId", "string", "rbd.version.unstable", 0, None),("certificate", "string", "rbd.version.unstable", 0, None),("key", "string", "rbd.version.unstable", 0, None),("force", "boolean", "rbd.version.unstable", F_OPTIONAL, None),), (0, "void", "void"), "AutoDeploy.Rule.Create", ["rbd.fault.CustomCertificateExistsFault", "rbd.fault.InvalidCertificateFault", ]), ("getCertificates", "GetCertificates", "rbd.version.unstable", (), (F_OPTIONAL, "rbd.CustomCertificateStore.CustomCertificateEntry[]", "rbd.CustomCertificateStore.CustomCertificateEntry[]"), None, None), ("removeCertificatesById", "RemoveCertificatesById", "rbd.version.unstable", (("certificateIds", "int[]", "rbd.version.unstable", F_OPTIONAL, None),), (0, "void", "void"), "AutoDeploy.Rule.Delete", None), ("removeCertificatesByHostId", "RemoveCertificatesByHostId", "rbd.version.unstable", (("hostIds", "string[]", "rbd.version.unstable", F_OPTIONAL, None),), (0, "void", "void"), "AutoDeploy.Rule.Delete", None)])
CreateDataType("rbd.CustomCertificateStore.CustomCertificateEntry", "RbdCustomCertificateStoreCustomCertificateEntry", "vmodl.DynamicData", "rbd.version.version1", [("key", "int", "rbd.version.version1", 0), ("hostId", "string", "rbd.version.version1", 0), ("expirationTime", "vmodl.DateTime", "rbd.version.version1", 0), ("timeCreated", "vmodl.DateTime", "rbd.version.version1", 0), ("lastModified", "vmodl.DateTime", "rbd.version.version1", 0), ("associatedHostName", "string", "rbd.version.version1", F_OPTIONAL)])
...
CreateDataType("rbd.fault.CustomCertificateExistsFault", "rbd1FaultCustomCertificateExistsFault", "vim.fault.ExtendedFault", "rbd.version.unstable", None)
...
CreateDataType("rbd.fault.InvalidCertificateFault", "rbd1FaultInvalidCertificateFault", "vim.fault.ExtendedFault", "rbd.version.unstable", None)
