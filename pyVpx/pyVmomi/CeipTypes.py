...
stableVersions.Add("phonehome.version.version1")
publicVersions.Add("phonehome.version.version1")
...
CreateManagedType("phonehome.service.ConsentConfigurationService", "PhonehomeServiceConsentConfigurationService", "vmodl.ManagedObject", "phonehome.version.version1", None, [("get", "PhonehomeServiceConsentConfigurationService_Get", "phonehome.version.version1", (), (0, "phonehome.data.ConsentConfigurationData", "phonehome.data.ConsentConfigurationData"), None, None), ("set", "PhonehomeServiceConsentConfigurationService_Set", "phonehome.version.version1", (("consentConfigs", "phonehome.data.ConsentConfigurationData", "phonehome.version.version1", 0, None),), (0, "void", "void"), "SSO.Administrator", None), ("validatePrivilegeForSet", "ValidatePrivilegeForSet", "phonehome.version.version1", (), (0, "void", "void"), "SSO.Administrator", None)])
CreateManagedType("phonehome.service.InstanceIdService", "PhonehomeServiceInstanceIdService", "vmodl.ManagedObject", "phonehome.version.version1", None, [("get", "PhonehomeServiceInstanceIdService_Get", "phonehome.version.version1", (), (0, "string", "string"), None, None)])
