...
AddVersion("vmodl.query.version.version4", "", "null", 0, "vim25")
AddVersion("vmodl.query.version.version3", "", "null", 0, "vim25")
AddVersion("vmodl.query.version.version2", "", "null", 0, "vim25")
AddVersion("vmodl.query.version.version1", "", "null", 0, "vim25")
...
CreateManagedType("eam.health.HealthStatus", "HealthHealthStatus", "vmodl.ManagedObject", "eam.version.version7", None, [("checkHost", "CheckHost", "eam.version.version7", (("host", "vim.HostSystem", "eam.version.version7", 0, None),("perspective", "string", "eam.version.version7", 0, None),), (0, "eam.health.StatusInfo", "eam.health.StatusInfo"), None, None)])
CreateEnumType("eam.health.HealthStatus.Perspective", "HealthHealthStatusPerspective", "eam.version.version1", ["INITIALIZATION"])
CreateDataType("eam.health.StatusInfo", "HealthStatusInfo", "vmodl.DynamicData", "eam.version.version7", [("status", "string", "eam.version.version7", 0), ("waitDuration", "long", "eam.version.version7", F_OPTIONAL), ("checksStatus", "eam.health.StatusInfo.CheckStatus[]", "eam.version.version7", F_OPTIONAL)])
CreateEnumType("eam.health.StatusInfo.Status", "HealthStatusInfoStatus", "eam.version.version1", ["OK", "WAIT", "NOT_OK"])
CreateDataType("eam.health.StatusInfo.CheckStatus", "HealthStatusInfoCheckStatus", "vmodl.DynamicData", "eam.version.version1", [("check", "string", "eam.version.version1", 0), ("status", "string", "eam.version.version1", 0), ("issue", "string", "eam.version.version1", F_OPTIONAL)])
...
CreateDataType("eam.Agency.VMNetworkMapping", "AgencyVMNetworkMapping", "vmodl.DynamicData", "eam.version.version6_9", [("name", "string", "eam.version.version6_9", 0), ("id", "vim.Network", "eam.version.version6_9", 0)])
...
CreateDataType("eam.Agency.VMPlacementPolicy", "AgencyVMPlacementPolicy", "vmodl.DynamicData", "eam.version.version6_9", [("agentCount", "int", "eam.version.version6_9", 0), ("vmDataAffinity", "string", "eam.version.version6_9", F_OPTIONAL), ("vmAntiAffinity", "string", "eam.version.version6_9", F_OPTIONAL)])
...
CreateDataType("eam.Agency.ConfigInfo", "AgencyConfigInfo", "vmodl.DynamicData", "eam.version.version1", [("agentConfig", "eam.Agent.ConfigInfo[]", "eam.version.version1", F_OPTIONAL), ("scope", "eam.Agency.Scope", "eam.version.version1", F_OPTIONAL), ("manuallyMarkAgentVmAvailableAfterProvisioning", "boolean", "eam.version.version1", F_OPTIONAL), ("manuallyMarkAgentVmAvailablePrePowerOn", "boolean", "eam.version.version7", F_OPTIONAL), ("manuallyMarkAgentVmAvailableAfterPowerOn", "boolean", "eam.version.version1", F_OPTIONAL), ("optimizedDeploymentEnabled", "boolean", "eam.version.version1", F_OPTIONAL), ("agentName", "string", "eam.version.version1", F_OPTIONAL), ("agencyName", "string", "eam.version.version1", F_OPTIONAL), ("manuallyProvisioned", "boolean", "eam.version.version2", F_OPTIONAL), ("manuallyMonitored", "boolean", "eam.version.version2", F_OPTIONAL), ("bypassVumEnabled", "boolean", "eam.version.version2", F_OPTIONAL), ("agentVmNetwork", "vim.Network[]", "eam.version.version2", F_OPTIONAL), ("vmNetworkMapping", "eam.Agency.VMNetworkMapping[]", "eam.version.version6_9", F_OPTIONAL), ("agentVmDatastore", "vim.Datastore[]", "eam.version.version2_5", F_OPTIONAL), ("preferHostConfiguration", "boolean", "eam.version.version2_5", F_OPTIONAL), ("ipPool", "vim.vApp.IpPool", "eam.version.version3", F_OPTIONAL), ("vmPlacementPolicy", "eam.Agency.VMPlacementPolicy", "eam.version.version6_9", F_OPTIONAL), ("resourcePools", "eam.Agency.VMResourcePool[]", "eam.version.version6_9", F_OPTIONAL), ("folders", "eam.Agency.VMFolder[]", "eam.version.version6_9", F_OPTIONAL)])
