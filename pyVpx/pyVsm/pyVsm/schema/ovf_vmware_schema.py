# ./ovf_vmware_schema.py
# PyXB bindings for NamespaceModule
# NSM:749129191fec4eefae2b6215e039be8d7390dd5b
# Generated 2019-06-08 05:43:45.525958 by PyXB version 1.1.1
import pyxb
import pyxb.binding
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:0dceb18a-89eb-11e9-a1fb-0200c306a57c')
...
class CTD_ANON_1 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __Provider = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Provider'), 'Provider', '__httpwww_vmware_comschemaovf_CTD_ANON_1_httpwww_vmware_comschemaovfProvider', True)
    ...
    __selected = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(Namespace, u'selected'), 'selected', '__httpwww_vmware_comschemaovf_CTD_ANON_1_httpwww_vmware_comschemaovfselected', pyxb.binding.datatypes.string)
...
class CTD_ANON_2 (pyxb.binding.basis.complexTypeDefinition):
    ...
    __Providers = pyxb.binding.content.ElementUse(pyxb.namespace.ExpandedName(Namespace, u'Providers'), 'Providers', '__httpwww_vmware_comschemaovf_CTD_ANON_2_httpwww_vmware_comschemaovfProviders', False)
...
CTD_ANON_1._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Provider'), vServiceProvider_Type, scope=CTD_ANON_1))
CTD_ANON_1._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=True, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=1, element_use=CTD_ANON_1._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Provider'))),
    ])
})
...
CTD_ANON_2._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Providers'), CTD_ANON_1, scope=CTD_ANON_2))
CTD_ANON_2._ContentModel = pyxb.binding.content.ContentModel(state_map = {
      1 : pyxb.binding.content.ContentModelState(state=1, is_final=False, transitions=[
        pyxb.binding.content.ContentModelTransition(next_state=2, element_use=CTD_ANON_2._UseForTag(pyxb.namespace.ExpandedName(Namespace, u'Providers'))),
    ])
...
vServiceDependencySection_Type._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, u'Annotations'), CTD_ANON_2, scope=vServiceDependencySection_Type))
